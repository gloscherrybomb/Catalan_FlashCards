...
const AUTHORED: AuthoredSentence[] = [
  ...
  { id: 'u3-18', categoryId: 'food', catalan: 'Un tallat i una torrada, si us plau.', english: 'A cortado and a slice of toast, please.', targetWords: ['tallat'] },
  ...
  { id: 'u6-13', categoryId: 'family', catalan: 'El seu net ja camina.', english: 'Their grandson can already walk.', targetWords: ['net'] },
  { id: 'u6-14', categoryId: 'family', catalan: 'La neta s’assembla a la seva mare.', english: 'The granddaughter looks like her mother.', targetWords: ['neta'] },
  ...
  { id: 'u6-18', categoryId: 'family', catalan: 'La tia ve a dinar diumenge.', english: 'My aunt is coming to lunch on Sunday.', targetWords: ['tia'] },
  ...
  { id: 'u15-13', categoryId: 'opinions', catalan: 'M’agradaria venir, però tinc feina.', english: 'I would like to come, but I have work.', targetWords: ['però'] },
  { id: 'u15-22', categoryId: 'opinions', catalan: 'És car; tanmateix, val la pena.', english: 'It is expensive; however, it is worth it.', targetWords: ['tanmateix'] },
