...
const UNIT_1: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'good morning', back: 'bon dia', category: 'Greetings', notes: 'Used from waking until about 2pm, not only before noon' },
    ...
    { front: 'please', back: 'si us plau', category: 'Greetings', notes: 'The standard written form, correct in every register' },
    { front: 'please (informal)', back: 'sisplau', category: 'Greetings', notes: 'How it is said and often written, though the IEC has not adopted it' },
...
const UNIT_2: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'I am...', back: 'Soc...', category: 'Phrases' },
    ...
    { front: 'Do you speak English? (formal)', back: 'Parla anglès?', category: 'Phrases' },
  ],
};
...
const UNIT_3: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'coffee with a dash of milk', back: 'tallat', category: 'Drinks', gender: 'masculine', notes: 'What to order if you want a cortado' },
...
const UNIT_4: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'pepper (the spice)', back: 'pebre', category: 'Food & Drink', gender: 'masculine' },
  ],
};
...
const UNIT_5: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'his/her/their (masc)', back: 'el seu', category: 'Possessives' },
    { front: 'his/her/their (fem)', back: 'la seva', category: 'Possessives' },
...
const UNIT_6: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'grandson', back: 'net', category: 'Family', gender: 'masculine' },
    { front: 'granddaughter', back: 'neta', category: 'Family', gender: 'feminine' },
    ...
    { front: 'aunt', back: 'tia', category: 'Family', gender: 'feminine', notes: 'Heard as tieta in the family, but tia is the standard word' },
...
const UNIT_10: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'Can I have...? (ordering at a bar)', back: 'Em posa...?', category: 'Phrases' },
...
const UNIT_11: UnitVocabulary = {
  ...
  words: [
    { front: "I don't like it", back: "no m'agrada", category: 'Phrases' },
...
const UNIT_12: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'starter / appetizer', back: 'entrant', category: 'Food & Drink', gender: 'masculine' },
    ...
    { front: 'spicy', back: 'picant', category: 'Adjectives' },
    { front: 'sweet', back: 'dolç / dolça', category: 'Adjectives' },
    { front: 'salty', back: 'salat / salada', category: 'Adjectives' },
    { front: 'bitter', back: 'amarg / amarga', category: 'Adjectives' },
    { front: 'raw', back: 'cru / crua', category: 'Adjectives' },
    { front: 'cooked', back: 'cuit / cuita', category: 'Adjectives' },
    { front: 'fried', back: 'fregit / fregida', category: 'Adjectives' },
    { front: 'grilled', back: 'a la planxa', category: 'Adjectives' },
  ],
};
...
const UNIT_13: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'to brush teeth', back: 'rentar-se les dents', category: 'Verbs' },
    { front: 'to get dressed', back: 'vestir-se', category: 'Verbs' },
    { front: 'to go to bed', back: 'anar a dormir', category: 'Verbs' },
    { front: 'to rest', back: 'descansar', category: 'Verbs' },
    { front: 'to read', back: 'llegir', category: 'Verbs' },
    { front: 'to watch TV', back: 'mirar la televisió', category: 'Verbs' },
    { front: 'to study', back: 'estudiar', category: 'Verbs' },
    { front: 'to cook', back: 'cuinar', category: 'Verbs' },
    { front: 'routine', back: 'rutina', category: 'Nouns', gender: 'feminine' },
    { front: 'schedule', back: 'horari', category: 'Nouns', gender: 'masculine' },
  ],
};
...
const UNIT_14: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'to go out / to leave', back: 'sortir', category: 'Verbs' },
    { front: 'to arrive', back: 'arribar', category: 'Verbs' },
    { front: 'to visit', back: 'visitar', category: 'Verbs' },
    { front: 'never (or "ever" in a question)', back: 'mai', category: 'Adverbs', notes: 'In negative sentences' },
    { front: 'I have bought', back: 'he comprat', category: 'Verbs' },
    { front: 'I have spoken', back: 'he parlat', category: 'Verbs' },
    { front: 'I have written', back: 'he escrit', category: 'Verbs' },
    { front: 'I have read', back: 'he llegit', category: 'Verbs' },
    { front: 'I have worked', back: 'he treballat', category: 'Verbs' },
    { front: 'I have finished', back: 'he acabat', category: 'Verbs' },
    { front: 'I have started', back: 'he començat', category: 'Verbs' },
    { front: 'just (now)', back: 'acabar de', category: 'Adverbs', notes: 'acabo de menjar = I have just eaten' },
    { front: 'lately', back: 'darrerament', category: 'Adverbs' },
    { front: 'recently', back: 'recentment', category: 'Adverbs' },
  ],
};
...
const UNIT_15: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'to seem', back: 'semblar', category: 'Verbs' },
    { front: 'to hope', back: 'esperar', category: 'Verbs' },
    { front: 'it seems that...', back: 'sembla que...', category: 'Phrases' },
    { front: 'on the other hand', back: "d'altra banda", category: 'Phrases' },
    { front: 'but', back: 'però', category: 'Phrases' },
    { front: 'however', back: 'tanmateix', category: 'Phrases' },
    { front: 'anyway', back: 'de totes maneres', category: 'Phrases' },
    { front: 'exactly', back: 'exactament', category: 'Adverbs' },
    { front: 'absolutely', back: 'absolutament', category: 'Adverbs' },
    { front: 'topic', back: 'tema', category: 'Nouns', gender: 'masculine' },
    { front: 'conversation', back: 'conversa', category: 'Nouns', gender: 'feminine' },
  ],
};
...
const UNIT_16: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'I was (identity/permanent)', back: 'vaig ser', category: 'Verbs', notes: 'For permanent states: I was a teacher' },
    { front: 'I was (state/location)', back: 'vaig estar', category: 'Verbs', notes: 'For temporary states: I was tired, I was at home' },
    ...
    { front: 'I said', back: 'vaig dir', category: 'Verbs' },
    { front: 'I bought', back: 'vaig comprar', category: 'Verbs' },
    { front: 'I wrote', back: 'vaig escriure', category: 'Verbs' },
    { front: 'I read', back: 'vaig llegir', category: 'Verbs' },
...
const UNIT_17: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'season (of the year)', back: "estació (de l'any)", category: 'Weather', gender: 'feminine' },
    { front: 'summer', back: 'estiu', category: 'Weather', gender: 'masculine' },
    { front: 'winter', back: 'hivern', category: 'Weather', gender: 'masculine' },
    { front: 'spring', back: 'primavera', category: 'Weather', gender: 'feminine' },
    { front: 'autumn', back: 'tardor', category: 'Weather', gender: 'feminine' },
    { front: 'it is snowing', back: 'neva', category: 'Weather' },
    { front: 'snow', back: 'neu', category: 'Weather', gender: 'feminine' },
    { front: 'storm', back: 'tempesta', category: 'Weather', gender: 'feminine' },
    { front: 'fog', back: 'boira', category: 'Weather', gender: 'feminine' },
    { front: 'I will be (identity/permanent)', back: 'seré', category: 'Verbs', notes: 'For permanent states: I will be a doctor' },
    { front: 'I will be (state/location)', back: 'estaré', category: 'Verbs', notes: 'For temporary states: I will be ready, I will be there' },
    { front: 'I will have', back: 'tindré', category: 'Verbs' },
    { front: 'I will come', back: 'vindré', category: 'Verbs' },
    { front: 'next week', back: 'la setmana que ve', category: 'Time' },
    { front: 'in the future', back: 'en el futur', category: 'Time' },
  ],
};
...
const UNIT_18: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'available', back: 'disponible', category: 'Adjectives' },
    { front: 'necessary', back: 'necessari / necessària', category: 'Adjectives' },
    { front: 'to reserve', back: 'reservar', category: 'Verbs' },
    { front: 'reservation', back: 'reserva', category: 'Nouns', gender: 'feminine' },
    { front: 'entrance', back: 'entrada', category: 'Places', gender: 'feminine' },
    { front: 'exit', back: 'sortida', category: 'Places', gender: 'feminine' },
    { front: 'discount', back: 'descompte', category: 'General', gender: 'masculine' },
    { front: 'included', back: 'inclòs / inclosa', category: 'Adjectives' },
  ],
};
...
const UNIT_19: UnitVocabulary = {
  ...
  words: [
    ...
    { front: 'station', back: 'estació (de tren)', category: 'Places', gender: 'feminine' },
    ...
    { front: 'tram', back: 'tramvia', category: 'Transport', gender: 'masculine' },
    { front: 'plane', back: 'avió', category: 'Transport', gender: 'masculine' },
    { front: 'airport', back: 'aeroport', category: 'Places', gender: 'masculine' },
    { front: 'delay', back: 'retard', category: 'Transport', gender: 'masculine' },
    { front: 'on time', back: 'puntual', category: 'Adjectives' },
    { front: 'connection', back: 'connexió', category: 'Transport', gender: 'feminine' },
    { front: 'luggage', back: 'equipatge', category: 'Objects', gender: 'masculine' },
    { front: 'seat', back: 'seient', category: 'Objects', gender: 'masculine' },
    { front: 'window', back: 'finestra', category: 'Objects', gender: 'feminine' },
    { front: 'aisle', back: 'passadís', category: 'Objects', gender: 'masculine' },
  ],
};
...
const UNIT_20: UnitVocabulary = {
  ...
  words: [
    { front: 'party / festival', back: 'festa', category: 'Culture', gender: 'feminine' },
    ...
    { front: 'Happy New Year!', back: 'Bon any nou!', category: 'Phrases' },
    { front: 'Easter', back: 'Pasqua', category: 'Culture', gender: 'feminine' },
    { front: 'Saint George Day', back: 'Sant Jordi', category: 'Culture', gender: 'masculine', notes: '23 April - books and roses' },
    { front: 'rose', back: 'rosa (la flor)', category: 'Objects', gender: 'feminine' },
    { front: 'dragon', back: 'drac', category: 'Objects', gender: 'masculine' },
    { front: 'knight', back: 'cavaller', category: 'People', gender: 'masculine' },
    { front: 'legend', back: 'llegenda', category: 'Culture', gender: 'feminine' },
    { front: 'to have a good time', back: "passar-s'ho bé", category: 'Verbs' },
    { front: 'to toast', back: 'brindar', category: 'Verbs' },
    { front: 'Cheers!', back: 'Salut!', category: 'Phrases' },
  ],
};
